...
#ifndef BOOST_CONTAINER_PMR_FIXED_MONOTONIC_BUFFER_RESOURCE_HPP
#define BOOST_CONTAINER_PMR_FIXED_MONOTONIC_BUFFER_RESOURCE_HPP
...
class BOOST_CONTAINER_DECL fixed_monotonic_buffer_resource
   : public memory_resource
{
   ...
   explicit fixed_monotonic_buffer_resource(memory_resource* upstream = 0) BOOST_NOEXCEPT;
   ...
   explicit fixed_monotonic_buffer_resource(std::size_t initial_size, memory_resource* upstream = 0) BOOST_NOEXCEPT;
   ...
   fixed_monotonic_buffer_resource(void* buffer, std::size_t buffer_size, memory_resource* upstream = 0) BOOST_NOEXCEPT;

   #if !defined(BOOST_NO_CXX11_DELETED_FUNCTIONS) || defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
   fixed_monotonic_buffer_resource(const fixed_monotonic_buffer_resource&) = delete;
   fixed_monotonic_buffer_resource operator=(const fixed_monotonic_buffer_resource&) = delete;
   #else
   private:
   fixed_monotonic_buffer_resource          (const fixed_monotonic_buffer_resource&);
   fixed_monotonic_buffer_resource operator=(const fixed_monotonic_buffer_resource&);
   public:
   #endif

   //! <b>Effects</b>: Calls
   //!   `this->release()`.
   virtual ~fixed_monotonic_buffer_resource();
