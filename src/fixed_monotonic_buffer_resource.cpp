...
void fixed_monotonic_buffer_resource::increase_next_buffer()
{
   m_next_buffer_size = (std::size_t(-1)/2 < m_next_buffer_size) ? std::size_t(-1) : m_next_buffer_size;
}

void fixed_monotonic_buffer_resource::increase_next_buffer_at_least_to(std::size_t minimum_size)
{
...
fixed_monotonic_buffer_resource::fixed_monotonic_buffer_resource(memory_resource* upstream) BOOST_NOEXCEPT
...
fixed_monotonic_buffer_resource::fixed_monotonic_buffer_resource(std::size_t initial_size, memory_resource* upstream) BOOST_NOEXCEPT
   : m_memory_blocks(upstream ? *upstream : *get_default_resource())
   , m_current_buffer(0u)
   , m_current_buffer_size(0u)
...
fixed_monotonic_buffer_resource::fixed_monotonic_buffer_resource(void* buffer, std::size_t buffer_size, memory_resource* upstream) BOOST_NOEXCEPT
   : m_memory_blocks(upstream ? *upstream : *get_default_resource())
...
fixed_monotonic_buffer_resource::~fixed_monotonic_buffer_resource()
{  this->release();  }

void fixed_monotonic_buffer_resource::release() BOOST_NOEXCEPT
{  m_memory_blocks.release();  }

memory_resource* fixed_monotonic_buffer_resource::upstream_resource() const BOOST_NOEXCEPT
{  return &m_memory_blocks.upstream_resource();   }

std::size_t fixed_monotonic_buffer_resource::remaining_storage(std::size_t alignment, std::size_t &wasted_due_to_alignment) const BOOST_NOEXCEPT
{
...
std::size_t fixed_monotonic_buffer_resource::remaining_storage(std::size_t alignment) const BOOST_NOEXCEPT
{
   std::size_t ignore_this;
   return this->remaining_storage(alignment, ignore_this);
}

const void *fixed_monotonic_buffer_resource::current_buffer() const BOOST_NOEXCEPT
{  return m_current_buffer;  }

std::size_t fixed_monotonic_buffer_resource::next_buffer_size() const BOOST_NOEXCEPT
{  return m_next_buffer_size;  }

void *fixed_monotonic_buffer_resource::allocate_from_current(std::size_t aligner, std::size_t bytes)
{
...
void* fixed_monotonic_buffer_resource::do_allocate(std::size_t bytes, std::size_t alignment)
{
...
void fixed_monotonic_buffer_resource::do_deallocate(void* p, std::size_t bytes, std::size_t alignment) BOOST_NOEXCEPT
{  (void)p; (void)bytes;  (void)alignment;  }

bool fixed_monotonic_buffer_resource::do_is_equal(const memory_resource& other) const BOOST_NOEXCEPT
{  return this == dynamic_cast<const fixed_monotonic_buffer_resource*>(&other);  }
